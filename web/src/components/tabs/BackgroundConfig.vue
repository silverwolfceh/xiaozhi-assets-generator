<template>
  <div class="space-y-6">
    <div>
      <h3 class="text-lg font-medium text-gray-900 mb-2">聊天背景配置</h3>
      <p class="text-gray-600">配置浅色模式和深色模式的聊天背景，支持纯色或自定义图片。</p>
    </div>
    ...
    <div class="space-y-4">
      ...
      <div class="border border-gray-200 rounded-lg p-4 space-y-4">
        ...
        <div v-if="modelValue.light.backgroundType === 'image'" class="space-y-3">
          <label class="text-sm font-medium text-gray-700">背景图片:</label>
          <div 
          ...
          >
            ...
            <div v-if="!modelValue.light.backgroundImage" @click="$refs.lightImageInput.click()">
              ...
              <p class="mt-1 text-sm text-gray-600">点击或拖拽上传背景图片</p>
            </div>
    ...
    <!-- 预览区域 -->
    <div class="space-y-4">
      <h4 class="font-medium text-gray-900">背景预览</h4>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <!-- 浅色模式预览 -->
        <div class="space-y-2">
          <div class="text-sm font-medium text-gray-700">浅色模式</div>
          <div 
        ...
        <!-- 深色模式预览 -->
        <div class="space-y-2">
          <div class="text-sm font-medium text-gray-700">深色模式</div>
          <div 
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
      <h5 class="font-medium text-blue-900 mb-2">快捷配置</h5>
